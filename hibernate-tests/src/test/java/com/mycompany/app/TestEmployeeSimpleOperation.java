...
public class TestEmployeeSimpleOperation extends BaseTest {
    ...
    @Test
    public void testSelectLotsOfObjects() {
        List<Employee> employeesBySalary = employeeService.getEmployeeBySalary(5500, 0, 500);
